STRINGS = {
    "en": {
        ...
        "cta_login_hint": "Already have an account?",
        ...
        "push_msg_on": "Notifications are on.",
        "push_msg_off": "Notifications turned off.",
        "push_msg_denied": "Notification permission was denied. Allow notifications for this site in your browser settings and try again.",
        "push_msg_unconfigured": "Push notifications aren't set up on the server yet — try again later.",
        "push_msg_unsupported": "Your browser doesn't support push notifications.",
        "push_msg_error": "Something went wrong. Please try again.",
    ...
    "tr": {
        ...
        "cta_login_hint": "Zaten hesabın var mı?",
        ...
        "followers_empty": "Henüz takipçisi yok.",
        "following_empty": "Henüz kimseyi takip etmiyor.",
        ...
        "push_msg_on": "Bildirimler açıldı.",
        "push_msg_off": "Bildirimler kapatıldı.",
        "push_msg_denied": "Bildirim izni reddedildi. Tarayıcı ayarlarından bu site için bildirimlere izin verip tekrar dene.",
        "push_msg_unconfigured": "Push bildirimi sunucuda henüz yapılandırılmadı — daha sonra tekrar dene.",
        "push_msg_unsupported": "Tarayıcın push bildirimini desteklemiyor.",
        "push_msg_error": "Bir şeyler ters gitti. Lütfen tekrar dene.",
